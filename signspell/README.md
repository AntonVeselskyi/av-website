...
- Signs 1–5: hold the calibrated number pose, then make a short downward strike.
- Signs 6–9: touch thumb to pinky, ring, middle, or index fingertip. A release is required before the next hit.
