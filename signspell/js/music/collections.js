...
export const VIBE_COLLECTIONS = Object.freeze({
  ...
  avianChamber: collection('avianChamber', 'BOWED CLOCKWORK', 'Looped violin, chamber plucks and human-scale rhythmic machinery.', { root: 'G', gamma: 'dorian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 4, 2, 5], bpm: 118 }, { '808': 'roundSub', bass: 'uprightShadow', eerieLead: 'whistleGlass', organ: 'reedChamber', steelGuitar: 'clockworkPluck', violin: 'loopedBow', piano: 'woodRoom', percussion: 'handMachine', drumKit: 'brushKit', pad: 'chamberAir' }),
  psychedelicSun: collection('psychedelicSun', 'PSYCH SUNROOM', 'Compressed psych bass, phaser-coloured synths and sun-bleached live drums.', { root: 'F#', gamma: 'dorian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 3, 7, 4], bpm: 126 }, { '808': 'roundSub', bass: 'sunsetCompressor', eerieLead: 'liquidPhase', organ: 'rotarySun', steelGuitar: 'tapeTwelve', violin: 'mellotronBow', piano: 'warpedKeys', percussion: 'tapeDust', drumKit: 'sunroomKit', pad: 'analogCloud' }),
});
