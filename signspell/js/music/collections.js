...
export const INSTRUMENTS = Object.freeze({
  ...
  overdrivenGuitar: Object.freeze({ id: 'overdrivenGuitar', label: 'Overdriven Guitar', kind: 'pitched', preferredMode: HARMONY_MODES.SAFE_SCALE, baseMidi: 40, lowMidi: 35, highMidi: 79 }),
  overdrivenBass: Object.freeze({ id: 'overdrivenBass', label: 'Overdriven Bass', kind: 'pitched', preferredMode: HARMONY_MODES.SAFE_SCALE, baseMidi: 28, lowMidi: 28, highMidi: 55 }),
...
export const VIBE_COLLECTIONS = Object.freeze({
  wiltedBedroom: collection('wiltedBedroom', 'WILTED BEDROOM', 'Warm, bruised emo-trap: detuned keys, worn plucks and a soft sagging sub.', { root: 'E', gamma: 'aeolian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 6, 3, 7], bpm: 132 }, { '808': 'warmWound', bass: 'softPickBass', eerieLead: 'velvetChorus', organ: 'bedroomReed', steelGuitar: 'oldBronze', overdrivenGuitar: 'frayedAmp', overdrivenBass: 'bruisedDriveBass', violin: 'softRosin', piano: 'feltTape', percussion: 'softRust', drumKit: 'bedroomKit', pad: 'sleepingHall' }),
  cemeteryTape: collection('cemeteryTape', 'CEMETERY TAPE', 'VHS horror-trap: metallic hits, spectral bells and compressed low end.', { root: 'D', gamma: 'harmonicMinor', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 6, 4, 5], bpm: 140 }, { '808': 'tapeGrave', bass: 'gravePickBass', eerieLead: 'neonCrypt', organ: 'funeralPipes', steelGuitar: 'graveWire', overdrivenGuitar: 'graveAmp', overdrivenBass: 'cryptDriveBass', violin: 'cryptRosin', piano: 'cryptKeys', percussion: 'vhsMetal', drumKit: 'cemeteryKit', pad: 'choirDust' }),
  redlineWound: collection('redlineWound', 'REDLINE WOUND', 'Intimate piano against clipped, close-up bass and sparse impact drums.', { root: 'F', gamma: 'minorPentatonic', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 4, 3, 5], bpm: 150 }, { '808': 'redline', bass: 'overdriveBass', eerieLead: 'nightDrive', organ: 'smallChurch', steelGuitar: 'brightScar', overdrivenGuitar: 'clippedAmp', overdrivenBass: 'redlineDriveBass', violin: 'closeBow', piano: 'bareFelt', percussion: 'impact', drumKit: 'redlineKit', pad: 'roomTone' }),
  ironChapel: collection('ironChapel', 'IRON CHAPEL', 'Industrial half-time trap: scraped metal, detuned organ and severe mono bass.', { root: 'C#', gamma: 'phrygian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 2, 7, 1], bpm: 165 }, { '808': 'ironLung', bass: 'fuzzBass', eerieLead: 'blackGlass', organ: 'ironDrawbar', steelGuitar: 'rustString', overdrivenGuitar: 'slagAmp', overdrivenBass: 'furnaceBass', violin: 'razorBow', piano: 'brokenOrgan', percussion: 'ironDust', drumKit: 'ironKit', pad: 'coldChapel' }),
  avianChamber: collection('avianChamber', 'BOWED CLOCKWORK', 'Looped violin, chamber plucks and human-scale rhythmic machinery.', { root: 'G', gamma: 'dorian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 4, 2, 5], bpm: 118 }, { '808': 'chamberSub', bass: 'uprightShadow', eerieLead: 'whistleGlass', organ: 'reedChamber', steelGuitar: 'clockworkPluck', overdrivenGuitar: 'chamberAmp', overdrivenBass: 'uprightDrive', violin: 'loopedBow', piano: 'woodRoom', percussion: 'handMachine', drumKit: 'brushKit', pad: 'chamberAir' }),
  psychedelicSun: collection('psychedelicSun', 'PSYCH SUNROOM', 'Compressed psych bass, phaser-coloured synths and sun-bleached live drums.', { root: 'F#', gamma: 'dorian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 3, 7, 4], bpm: 126 }, { '808': 'sunsetSub', bass: 'sunsetCompressor', eerieLead: 'liquidPhase', organ: 'rotarySun', steelGuitar: 'tapeTwelve', overdrivenGuitar: 'sunFuzz', overdrivenBass: 'liquidDriveBass', violin: 'mellotronBow', piano: 'warpedKeys', percussion: 'tapeDust', drumKit: 'sunroomKit', pad: 'analogCloud' }),
  hollowVoltage: collection('hollowVoltage', 'HOLLOW VOLTAGE', 'Original volatile alt-metal: syncopated detuned riffs, elastic driven bass and dry explosive drums.', { root: 'B', gamma: 'phrygian', harmonyMode: HARMONY_MODES.STRICT_CHORD, progression: [1, 2, 6, 1], bpm: 154 }, { '808': 'voltageSub', bass: 'voltageBass', eerieLead: 'staticChoir', organ: 'valveRitual', steelGuitar: 'detunedWire', overdrivenGuitar: 'toxicAmp', overdrivenBass: 'elasticBass', violin: 'feverBow', piano: 'hammerKeys', percussion: 'boltDust', drumKit: 'voltageKit', pad: 'blackoutPad' }),
});
