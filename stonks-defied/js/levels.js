  ...
  L.PRESETS = [
    {
      ...
      par: 25, amp: 150, dx: 54, slope: 1.05, drop: 1.05, smooth: 2,
    ...
    },
    {
      ...
      par: 30, n: 100, amp: 300, dx: 58, slope: 1.3, drop: 2.6, punch: 1.2, smooth: 0,
    ...
    },
    {
      ...
      par: 30, n: 92, amp: 520, dx: 64, slope: 1.4, drop: 3.9, punch: 2.4, scale: 'log', smooth: 0,
    ...
    },
    {
      ...
      par: 30, n: 92, amp: 370, dx: 66, slope: 1.45, drop: 3.2, punch: 1.8, smooth: 0,
    ...
    },
    {
      ...
      par: 25, n: 88, amp: 550, dx: 64, slope: 1.46, drop: 4.0, punch: 2.5, smooth: 0,
    ...
    },
    {
      ...
      par: 30, n: 90, amp: 420, dx: 64, slope: 1.4, drop: 3.3, punch: 1.6, scale: 'linear', smooth: 0,
    ...
    },
    {
      ...
      par: 30, n: 92, amp: 520, dx: 64, slope: 1.4, drop: 3.9, punch: 2.4, scale: 'linear', smooth: 0,
    ...
    },
    {
      ...
      par: 30, n: 92, amp: 480, dx: 66, slope: 1.35, drop: 3.9, punch: 1.9, smooth: 0, scale: 'log',
    ...
    },
    {
      ...
      par: 30, n: 94, amp: 550, dx: 66, slope: 1.45, drop: 4.0, punch: 2.5, scale: 'sqrt', smooth: 0,
