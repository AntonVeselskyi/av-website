...
(function () {
  ...
  L.PRESETS = [
    ...
    },
    {
      ...
      par: 30, amp: 210, dx: 55, slope: 1.2, smooth: 1,
    ...
    },
    {
      ...
      par: 30, amp: 260, dx: 55, slope: 1.32, smooth: 1,
    ...
    },
    {
      ...
      par: 25, amp: 300, dx: 56, slope: 1.38, smooth: 1,
    ...
    },
    {
      ...
      par: 30, amp: 330, dx: 56, slope: 1.45, smooth: 1, log: true,
    ...
    },
    {
      ...
      par: 30, amp: 320, dx: 55, slope: 1.42, smooth: 1, log: true,
  ...
  L.buildTerrain = function (def) {
    ...
    // shape values (optionally log-scaled for 50x movers), then normalize
    let vals = raw.map(def.log ? (v => Math.log(Math.max(v, 1e-6))) : (v => v));
